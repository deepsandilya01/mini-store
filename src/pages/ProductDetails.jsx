  ...
  if (!product)
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-zinc-950 px-4">
        <div className="rounded-2xl bg-white dark:bg-zinc-900 p-8 text-center shadow-lg max-w-md">
        ...
        <div className="grid gap-10 md:grid-cols-2">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="mt-6 flex gap-4">
              <button
                className="
                flex-1 rounded-xl bg-indigo-600 px-6 py-3 text-white
              ...
              <button
                className="
                flex-1 rounded-xl border border-gray-300 dark:border-zinc-700
                px-6 py-3 text-gray-800 dark:text-zinc-100
