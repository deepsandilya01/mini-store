  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-100 dark:bg-zinc-950">
      ...
      >
        {/* Outer */}
        <svg
          className="circle-outer absolute h-21.5 w-21.5"
          viewBox="0 0 86 86"
        >
        ...
        {/* Middle */}
        <svg
          className="circle-middle absolute h-15 w-15"
          viewBox="0 0 60 60"
        >
        ...
        {/* Inner */}
        <svg
          className="circle-inner absolute h-8.5 w-8.5"
          viewBox="0 0 34 34"
        >
        ...
        {/* Text */}
        <div
          className="text absolute -bottom-10 text-sm font-medium text-gray-700 dark:text-zinc-300"
          data-text="loading"
        />
      </div>
    </div>
